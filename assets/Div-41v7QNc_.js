import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as r}from"./Tabula-ORd-0ym0.js";const t="_element_19mzt_1",u={element:t};function i(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[u.element];return l.push(...r.getUtilityClassNames(a)),a.className&&l.push(a.className),n.jsx("div",{...e,className:l.join(" ")})}i.__docgenInfo={description:"",methods:[],displayName:"Div",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
