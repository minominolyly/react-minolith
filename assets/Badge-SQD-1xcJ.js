import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{c as t}from"./Tabula-OTilzUjG.js";const u="_badge_1ljkc_1",n={badge:u,"is-small":"_is-small_1ljkc_15","is-gray":"_is-gray_1ljkc_20","is-red":"_is-red_1ljkc_25","is-orange":"_is-orange_1ljkc_30","is-yellow":"_is-yellow_1ljkc_35","is-green":"_is-green_1ljkc_40","is-cyan":"_is-cyan_1ljkc_45","is-blue":"_is-blue_1ljkc_50","is-violet":"_is-violet_1ljkc_55","is-magenta":"_is-magenta_1ljkc_60","is-clickable":"_is-clickable_1ljkc_65","is-focus":"_is-focus_1ljkc_69","is-focused":"_is-focused_1ljkc_69","is-hovered":"_is-hovered_1ljkc_74","is-active":"_is-active_1ljkc_79","is-disabled":"_is-disabled_1ljkc_85","is-hover":"_is-hover_1ljkc_74"};function i(a){const e={...a};delete e.colorName,delete e.isSmall,delete e.as,delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[n.badge];return a.colorName&&l.push(n[`is-${a.colorName}`]),a.isSmall&&l.push(n["is-small"]),l.push(...t.getUtilityClassNames(a)),a.className&&l.push(a.className),a.as?r.jsx(a.as,{...e,className:l.join(" ")}):r.jsx("span",{...e,className:l.join(" ")})}i.__docgenInfo={description:"",methods:[],displayName:"Badge",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
...
| "blue"
| "violet"
| "magenta"`,elements:[{name:"literal",value:'"gray"'},{name:"literal",value:'"red"'},{name:"literal",value:'"orange"'},{name:"literal",value:'"yellow"'},{name:"literal",value:'"green"'},{name:"literal",value:'"cyan"'},{name:"literal",value:'"blue"'},{name:"literal",value:'"violet"'},{name:"literal",value:'"magenta"'}]},description:""},isSmall:{required:!1,tsType:{name:"boolean"},description:""},as:{required:!1,tsType:{name:"union",raw:"React.ElementType | undefined",elements:[{name:"ReactElementType",raw:"React.ElementType"},{name:"undefined"}]},description:""}}};export{i as B};
