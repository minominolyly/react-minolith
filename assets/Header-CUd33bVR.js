import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{c as t}from"./Tabula-ORd-0ym0.js";const u="_header_1bsa0_1",n={header:u,"is-sticky":"_is-sticky_1bsa0_7","is-gray":"_is-gray_1bsa0_14","is-red":"_is-red_1bsa0_19","is-orange":"_is-orange_1bsa0_24","is-yellow":"_is-yellow_1bsa0_29","is-green":"_is-green_1bsa0_34","is-cyan":"_is-cyan_1bsa0_39","is-blue":"_is-blue_1bsa0_44","is-violet":"_is-violet_1bsa0_49","is-magenta":"_is-magenta_1bsa0_54"};function i(a){const e={...a};delete e.colorName,delete e.isSticky,delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[n.header];return a.colorName&&l.push(n[`is-${a.colorName}`]),a.isSticky&&l.push(n["is-sticky"]),l.push(...t.getUtilityClassNames(a)),a.className&&l.push(a.className),r.jsx("header",{...e,className:l.join(" ")})}i.__docgenInfo={description:"",methods:[],displayName:"Header",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
