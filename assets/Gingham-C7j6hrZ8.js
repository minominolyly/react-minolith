import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{c as t}from"./Tabula-ORd-0ym0.js";const u="_gingham_mpg5g_1",n={gingham:u,"is-0deg":"_is-0deg_mpg5g_6","is-45deg":"_is-45deg_mpg5g_9","is-90deg":"_is-90deg_mpg5g_12","is-135deg":"_is-135deg_mpg5g_15","is-180deg":"_is-180deg_mpg5g_18","is-gray":"_is-gray_mpg5g_21","is-red":"_is-red_mpg5g_40","is-orange":"_is-orange_mpg5g_59","is-yellow":"_is-yellow_mpg5g_78","is-green":"_is-green_mpg5g_97","is-cyan":"_is-cyan_mpg5g_116","is-blue":"_is-blue_mpg5g_135","is-violet":"_is-violet_mpg5g_154","is-magenta":"_is-magenta_mpg5g_173"};function i(a){const e={...a};delete e.colorName,delete e.degree,delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[n.gingham];return a.colorName&&l.push(n[`is-${a.colorName}`]),a.degree&&l.push(n[`is-${a.degree}deg`]),l.push(...t.getUtilityClassNames(a)),a.className&&l.push(a.className),r.jsx("div",{...e,className:l.join(" ")})}i.__docgenInfo={description:"",methods:[],displayName:"Gingham",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
...
| "blue"
| "violet"
| "magenta"`,elements:[{name:"literal",value:'"gray"'},{name:"literal",value:'"red"'},{name:"literal",value:'"orange"'},{name:"literal",value:'"yellow"'},{name:"literal",value:'"green"'},{name:"literal",value:'"cyan"'},{name:"literal",value:'"blue"'},{name:"literal",value:'"violet"'},{name:"literal",value:'"magenta"'}]},description:""},degree:{required:!1,tsType:{name:"union",raw:"0 | 45 | 90 | 135 | 180",elements:[{name:"literal",value:"0"},{name:"literal",value:"45"},{name:"literal",value:"90"},{name:"literal",value:"135"},{name:"literal",value:"180"}]},description:""}}};export{i as G};
