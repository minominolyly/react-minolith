import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{c as o}from"./classNameUtility-tv8HPb6e.js";import{M as s}from"./MinolithStatic-Q1pWSQd6.js";import"./index-CqrSl2Gl.js";const g="_header_q33mj_1",r={header:g,"is-sticky":"_is-sticky_q33mj_7"};function u(e){const a={...e};delete a.colorName,delete a.isSticky,delete a.fore,delete a.back,delete a.border,delete a.highlighter,delete a.spacing;const l=[r.header];return e.colorName&&l.push(r[`is-${e.colorName}`]),e.isSticky&&l.push(r["is-sticky"]),l.push(...o.getUtilityClassNames(e)),e.className&&l.push(e.className),t.jsx("header",{...a,className:l.join(" ")})}u.__docgenInfo={description:"",methods:[],displayName:"Header",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
