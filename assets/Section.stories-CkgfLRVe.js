import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as v}from"./classNameUtility-tv8HPb6e.js";import{M as o}from"./MinolithStatic-Q1pWSQd6.js";import"./index-CqrSl2Gl.js";function r(e){const a={...e};delete a.fore,delete a.back,delete a.border,delete a.highlighter,delete a.spacing;const t=[];return t.push(...v.getUtilityClassNames(e)),e.className&&t.push(e.className),n.jsx("section",{...a,className:t.join(" ")})}r.__docgenInfo={description:"",methods:[],displayName:"Section",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
