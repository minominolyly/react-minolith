import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as r}from"./Tabula-ORd-0ym0.js";const t="_paragraph_1dpzn_1",u={paragraph:t};function i(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[u.paragraph];return l.push(...r.getUtilityClassNames(a)),a.className&&l.push(a.className),n.jsx("p",{...e,className:l.join(" ")})}i.__docgenInfo={description:"",methods:[],displayName:"Paragraph",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
