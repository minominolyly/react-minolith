import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as r}from"./Tabula-OTilzUjG.js";const t="_container_18940_1",u={container:t};function i(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[u.container];return l.push(...r.getUtilityClassNames(a)),a.className&&l.push(a.className),n.jsx("div",{...e,className:l.join(" ")})}i.__docgenInfo={description:"",methods:[],displayName:"Container",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
