import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{c as t}from"./Tabula-ORd-0ym0.js";const u="_header_1oe4v_1",n={header:u,"is-sticky":"_is-sticky_1oe4v_8","is-gray":"_is-gray_1oe4v_15","is-red":"_is-red_1oe4v_20","is-orange":"_is-orange_1oe4v_25","is-yellow":"_is-yellow_1oe4v_30","is-green":"_is-green_1oe4v_35","is-cyan":"_is-cyan_1oe4v_40","is-blue":"_is-blue_1oe4v_45","is-violet":"_is-violet_1oe4v_50","is-magenta":"_is-magenta_1oe4v_55"};function i(a){const e={...a};delete e.colorName,delete e.isSticky,delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[n.header];return a.colorName&&l.push(n[`is-${a.colorName}`]),a.isSticky&&l.push(n["is-sticky"]),l.push(...t.getUtilityClassNames(a)),a.className&&l.push(a.className),r.jsx("header",{...e,className:l.join(" ")})}i.__docgenInfo={description:"",methods:[],displayName:"Header",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
