import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as i}from"./Tabula-C_xKIuFK.js";import{M as g}from"./MinolithStatic-qxgbC_3i.js";import"./index-DmM0KDA7.js";const p="_breadcrumbs_1b4gq_1",d="_breadcrumb_1b4gq_1",u={breadcrumbs:p,breadcrumb:d,"is-gray":"_is-gray_1b4gq_25","is-red":"_is-red_1b4gq_31","is-orange":"_is-orange_1b4gq_37","is-yellow":"_is-yellow_1b4gq_43","is-green":"_is-green_1b4gq_49","is-cyan":"_is-cyan_1b4gq_55","is-blue":"_is-blue_1b4gq_61","is-violet":"_is-violet_1b4gq_67","is-magenta":"_is-magenta_1b4gq_73","breadcrumbs-nav":"_breadcrumbs-nav_1b4gq_80"};function m(a){const e={...a};delete e.colorName,delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[u.breadcrumbs];return a.colorName&&l.push(u[`is-${a.colorName}`]),l.push(...i.getUtilityClassNames(a)),a.className&&l.push(a.className),n.jsx("ul",{...e,className:l.join(" ")})}m.__docgenInfo={description:"",methods:[],displayName:"Breadcrumbs",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
...
| "blue"
| "violet"
| "magenta"`,elements:[{name:"literal",value:'"gray"'},{name:"literal",value:'"red"'},{name:"literal",value:'"orange"'},{name:"literal",value:'"yellow"'},{name:"literal",value:'"green"'},{name:"literal",value:'"cyan"'},{name:"literal",value:'"blue"'},{name:"literal",value:'"violet"'},{name:"literal",value:'"magenta"'}]},description:""}},composes:["DetailedHTMLProps"]};function t(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[u.breadcrumb];return l.push(...i.getUtilityClassNames(a)),a.className&&l.push(a.className),n.jsx("li",{...e,className:l.join(" ")})}t.__docgenInfo={description:"",methods:[],displayName:"Breadcrumb",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps<ColorName | "rainbow">;
  fontSize?: FontSize;
  fontWeight?: FontWeight;
  isItalic?: boolean;
...
| "auto"`,elements:[{name:"signature",type:"object",raw:`{
  ...
  bottom?: number | "auto";
  right?: number | "auto";
}`,signature:{properties:[{key:"x",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"y",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"top",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"left",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"bottom",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"right",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},description:""}},composes:["DetailedHTMLProps"]};function y(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[u["breadcrumbs-nav"]];return l.push(...i.getUtilityClassNames(a)),a.className&&l.push(a.className),n.jsx("nav",{"aria-label":"breadcrumb",...e,className:l.join(" ")})}y.__docgenInfo={description:"",methods:[],displayName:"BreadcrumbsNav",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps<ColorName | "rainbow">;
  fontSize?: FontSize;
  fontWeight?: FontWeight;
  isItalic?: boolean;
...
| "auto"`,elements:[{name:"signature",type:"object",raw:`{
  ...
  bottom?: number | "auto";
  right?: number | "auto";
}`,signature:{properties:[{key:"x",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"y",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"top",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"left",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"bottom",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"right",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},description:""}}};const k={title:"Components/Breadcrumbs",component:m,tags:["autodocs"],argTypes:{}},r={args:{colorName:void 0},render:a=>n.jsx(g,{children:n.jsx(y,{children:n.jsxs(m,{...a,children:[n.jsx(t,{children:"Item 1"}),n.jsx(t,{children:"Item 2"}),n.jsx(t,{children:"Item 3"})]})})})};var v,o,s;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    colorName: undefined
  },
...
}`,...(s=(o=r.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const N=["Plain"];export{r as Plain,N as __namedExportsOrder,k as default};
