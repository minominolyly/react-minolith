import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{c as o}from"./Tabula-ORd-0ym0.js";import{M as s}from"./MinolithStatic-Ba1-Mxfp.js";import"./index-CqrSl2Gl.js";const g="_link_szays_1",u={link:g,"is-gray":"_is-gray_szays_15","is-red":"_is-red_szays_21","is-orange":"_is-orange_szays_27","is-yellow":"_is-yellow_szays_33","is-green":"_is-green_szays_39","is-cyan":"_is-cyan_szays_45","is-blue":"_is-blue_szays_51","is-violet":"_is-violet_szays_57","is-magenta":"_is-magenta_szays_63"};function t(a){const e={...a};delete e.as,delete e.colorName,delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[u.link];return a.colorName&&l.push(u[`is-${a.colorName}`]),l.push(...o.getUtilityClassNames(a)),a.className&&l.push(a.className),a.as?r.jsx(a.as,{...e,className:l.join(" ")}):r.jsx("a",{...e,className:l.join(" ")})}t.__docgenInfo={description:"",methods:[],displayName:"Link",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
...
| "blue"
| "violet"
| "magenta"`,elements:[{name:"literal",value:'"gray"'},{name:"literal",value:'"red"'},{name:"literal",value:'"orange"'},{name:"literal",value:'"yellow"'},{name:"literal",value:'"green"'},{name:"literal",value:'"cyan"'},{name:"literal",value:'"blue"'},{name:"literal",value:'"violet"'},{name:"literal",value:'"magenta"'}]},description:""}}};const c={title:"Components/Link",component:t,tags:["autodocs"],argTypes:{}},n={args:{as:"a"},render:a=>r.jsx(s,{children:r.jsx(t,{...a,children:"Link"})})};var i,m,v;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    as: "a"
  },
