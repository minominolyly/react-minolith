import{j as l}from"./jsx-runtime-D_zvdyIk.js";import{c as v}from"./classNameUtility-tv8HPb6e.js";import{M as o}from"./MinolithStatic-Q1pWSQd6.js";import"./index-CqrSl2Gl.js";function t(e){const a={...e};delete a.rubyText,delete a.fore,delete a.back,delete a.border,delete a.highlighter,delete a.spacing;const r=[];return r.push(...v.getUtilityClassNames(e)),e.className&&r.push(e.className),l.jsxs("ruby",{...a,className:r.join(" "),children:[e.children,l.jsx("rp",{children:"("}),l.jsx("rt",{children:e.rubyText}),l.jsx("rp",{children:")"})]})}t.__docgenInfo={description:"",methods:[],displayName:"Ruby",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
