import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as v}from"./Tabula-ORd-0ym0.js";import{M as o}from"./MinolithStatic-Ba1-Mxfp.js";import"./index-CqrSl2Gl.js";const s="_span_m9a43_1",g={span:s};function t(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const r=[g.span];return r.push(...v.getUtilityClassNames(a)),a.className&&r.push(a.className),n.jsx("span",{...e,className:r.join(" ")})}t.__docgenInfo={description:"",methods:[],displayName:"Span",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
