import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as v}from"./Tabula-OTilzUjG.js";import{M as o}from"./MinolithStatic-B2szigXC.js";import"./index-CqrSl2Gl.js";function r(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const t=[];return t.push(...v.getUtilityClassNames(a)),a.className&&t.push(a.className),n.jsx("section",{...e,className:t.join(" ")})}r.__docgenInfo={description:"",methods:[],displayName:"Section",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
