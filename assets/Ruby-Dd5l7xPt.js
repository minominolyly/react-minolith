import{j as l}from"./jsx-runtime-D_zvdyIk.js";import{c as t}from"./Tabula-C_xKIuFK.js";const m="_element_1py2f_1",u={element:m};function i(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const n=[u.element];return n.push(...t.getUtilityClassNames(a)),a.className&&n.push(a.className),l.jsxs(l.Fragment,{children:[l.jsx("rp",{children:"("}),l.jsx("rt",{...e,className:n.join(" ")}),l.jsx("rp",{children:")"})]})}i.__docgenInfo={description:"",methods:[],displayName:"RubyText",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
...
| "auto"`,elements:[{name:"signature",type:"object",raw:`{
  ...
  bottom?: number | "auto";
  right?: number | "auto";
}`,signature:{properties:[{key:"x",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"y",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"top",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"left",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"bottom",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"right",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},description:""}},composes:["DetailedHTMLProps"]};function v(a){const e={...a};delete e.rubyText,delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const n=["ruby",u.element];n.push(...t.getUtilityClassNames(a)),a.className&&n.push(a.className);const r=["ruby-text",u.element];return a.rubyText&&(r.push(...t.getUtilityClassNames(a)),a.className&&r.push(a.className)),l.jsxs("ruby",{...e,className:n.join(" "),children:[a.children,a.rubyText?l.jsx(i,{className:r.join(" "),children:a.rubyText}):l.jsx(l.Fragment,{})]})}v.__docgenInfo={description:"",methods:[],displayName:"Ruby",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps<ColorName | "rainbow">;
  fontSize?: FontSize;
  fontWeight?: FontWeight;
  isItalic?: boolean;
...
| "auto"`,elements:[{name:"signature",type:"object",raw:`{
  ...
  bottom?: number | "auto";
  right?: number | "auto";
}`,signature:{properties:[{key:"x",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"y",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"top",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"left",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"bottom",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"right",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},description:""},rubyText:{required:!1,tsType:{name:"string"},description:""}},composes:["DetailedHTMLProps"]};export{v as R,i as a};
