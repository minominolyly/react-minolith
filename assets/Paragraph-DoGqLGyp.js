import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as r}from"./Tabula-C_xKIuFK.js";const t="_paragraph_f19qm_1",u={paragraph:t};function i(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[u.paragraph];return l.push(...r.getUtilityClassNames(a)),a.className&&l.push(a.className),n.jsx("p",{...e,className:l.join(" ")})}i.__docgenInfo={description:"",methods:[],displayName:"Paragraph",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
...
| "auto"`,elements:[{name:"signature",type:"object",raw:`{
  ...
  bottom?: number | "auto";
  right?: number | "auto";
}`,signature:{properties:[{key:"x",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"y",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"top",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"left",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"bottom",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"right",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},description:""}}};export{i as P};
