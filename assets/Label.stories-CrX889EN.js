import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{c as o}from"./Tabula-ORd-0ym0.js";import{M as s}from"./MinolithStatic-D46fgrYP.js";import"./index-CqrSl2Gl.js";const g="_label_16xtb_1",u={label:g,"is-gray":"_is-gray_16xtb_5","is-red":"_is-red_16xtb_8","is-orange":"_is-orange_16xtb_11","is-yellow":"_is-yellow_16xtb_14","is-green":"_is-green_16xtb_17","is-cyan":"_is-cyan_16xtb_20","is-blue":"_is-blue_16xtb_23","is-violet":"_is-violet_16xtb_26","is-magenta":"_is-magenta_16xtb_29"};function t(a){const e={...a};delete e.colorName,delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[u.label];return a.colorName&&l.push(u[`is-${a.colorName}`]),l.push(...o.getUtilityClassNames(a)),a.className&&l.push(a.className),r.jsx("label",{...e,className:l.join(" ")})}t.__docgenInfo={description:"",methods:[],displayName:"Label",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
...
| "blue"
| "violet"
| "magenta"`,elements:[{name:"literal",value:'"gray"'},{name:"literal",value:'"red"'},{name:"literal",value:'"orange"'},{name:"literal",value:'"yellow"'},{name:"literal",value:'"green"'},{name:"literal",value:'"cyan"'},{name:"literal",value:'"blue"'},{name:"literal",value:'"violet"'},{name:"literal",value:'"magenta"'}]},description:""}}};const c={title:"Components/Label",component:t,tags:["autodocs"],argTypes:{}},n={args:{},render:a=>r.jsx(s,{children:r.jsx(t,{...a,children:"Plain"})})};var i,m,v;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {},
