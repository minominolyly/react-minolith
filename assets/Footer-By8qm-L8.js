import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{c as t}from"./Tabula-C_xKIuFK.js";const u="_footer_1vs01_1",n={footer:u,"is-gray":"_is-gray_1vs01_10","is-red":"_is-red_1vs01_14","is-orange":"_is-orange_1vs01_18","is-yellow":"_is-yellow_1vs01_22","is-green":"_is-green_1vs01_26","is-cyan":"_is-cyan_1vs01_30","is-blue":"_is-blue_1vs01_34","is-violet":"_is-violet_1vs01_38","is-magenta":"_is-magenta_1vs01_42"};function i(a){const e={...a};delete e.colorName,delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const l=[n.Footer];return a.colorName&&l.push(n[`is-${a.colorName}`]),l.push(...t.getUtilityClassNames(a)),a.className&&l.push(a.className),r.jsx("footer",{...e,className:l.join(" ")})}i.__docgenInfo={description:"",methods:[],displayName:"Footer",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
...
| "blue"
| "violet"
| "magenta"`,elements:[{name:"literal",value:'"gray"'},{name:"literal",value:'"red"'},{name:"literal",value:'"orange"'},{name:"literal",value:'"yellow"'},{name:"literal",value:'"green"'},{name:"literal",value:'"cyan"'},{name:"literal",value:'"blue"'},{name:"literal",value:'"violet"'},{name:"literal",value:'"magenta"'}]},description:""}}};export{i as F};
