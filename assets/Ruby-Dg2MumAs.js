import{j as l}from"./jsx-runtime-D_zvdyIk.js";import{c as r}from"./Tabula-ORd-0ym0.js";const t="_element_19mzt_1",u={element:t};function i(a){const e={...a};delete e.rubyText,delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const n=[u.element];return n.push(...r.getUtilityClassNames(a)),a.className&&n.push(a.className),l.jsxs("ruby",{...e,className:n.join(" "),children:[a.children,l.jsx("rp",{children:"("}),l.jsx("rt",{children:a.rubyText}),l.jsx("rp",{children:")"})]})}i.__docgenInfo={description:"",methods:[],displayName:"Ruby",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
