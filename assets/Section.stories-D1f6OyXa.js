import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as v}from"./Tabula-ORd-0ym0.js";import{M as o}from"./MinolithStatic-D46fgrYP.js";import"./index-CqrSl2Gl.js";const s="_element_19mzt_1",g={element:s};function r(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const t=[g.element];return t.push(...v.getUtilityClassNames(a)),a.className&&t.push(a.className),n.jsx("section",{...e,className:t.join(" ")})}r.__docgenInfo={description:"",methods:[],displayName:"Section",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
...
| "auto"`,elements:[{name:"signature",type:"object",raw:`{
  ...
  bottom?: number | "auto";
  right?: number | "auto";
}`,signature:{properties:[{key:"x",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"y",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"top",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"left",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"bottom",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}},{key:"right",value:{name:"union",raw:'number | "auto"',elements:[{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},{name:"number"},{name:"literal",value:'"auto"'}],required:!1}}]}},description:""}}};const c={title:"Components/Section",component:r,tags:["autodocs"],argTypes:{}},l={args:{},render:a=>n.jsx(o,{children:n.jsx(r,{...a,children:n.jsx(r,{children:"Plain"})})})};var u,i,m;l.parameters={...l.parameters,docs:{...(u=l.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {},
