import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as v}from"./Tabula-CyfH5cAW.js";import{M as o}from"./MinolithStatic-D0YKXBr9.js";import"./index-CqrSl2Gl.js";function t(a){const e={...a};delete e.fore,delete e.back,delete e.highlighter,delete e.border,delete e.positioning,delete e.sizing,delete e.spacing;const r=[];return r.push(...v.getUtilityClassNames(a)),a.className&&r.push(a.className),n.jsx("span",{...e,className:r.join(" ")})}t.__docgenInfo={description:"",methods:[],displayName:"Span",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
