import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{c as v}from"./classNameUtility-tv8HPb6e.js";import{M as o}from"./MinolithStatic-Q1pWSQd6.js";import"./index-CqrSl2Gl.js";const s="_container_18940_1",g={container:s};function t(e){const a={...e};delete a.fore,delete a.back,delete a.border,delete a.highlighter,delete a.spacing;const n=[g.container];return n.push(...v.getUtilityClassNames(e)),e.className&&n.push(e.className),r.jsx("div",{...a,className:n.join(" ")})}t.__docgenInfo={description:"",methods:[],displayName:"Container",props:{fore:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  color?: ColorProps;
  fontSize?: FontSize;
