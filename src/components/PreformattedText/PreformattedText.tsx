...
import classNames from "./PreformattedText.module.scss";
import type PreformattedTextProps from "./PreformattedTextProps";

export default function PreformattedText<
  BaseComponentColorNameType extends string = ColorName | "rainbow",
  PropsType extends BasePreformattedTextProps<BaseComponentColorNameType> =
    PreformattedTextProps<BaseComponentColorNameType>,
