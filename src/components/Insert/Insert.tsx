...
import classNames from "./Insert.module.scss";
import type InsertProps from "./InsertProps";
import type BaseInsertProps from "./BaseInsertProps";

export default function Insert<
  BaseComponentColorNameType extends string = ColorName | "rainbow",
  PropsType extends BaseInsertProps<BaseComponentColorNameType> =
    InsertProps<BaseComponentColorNameType>,
