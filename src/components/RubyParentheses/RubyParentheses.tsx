...
import classNames from "./RubyParentheses.module.scss";
import type RubyParenthesesProps from "./RubyParenthesesProps";

export default function RubyParentheses<
  BaseComponentColorNameType extends string = ColorName | "rainbow",
  PropsType extends BaseRubyParenthesesProps<BaseComponentColorNameType> =
    RubyParenthesesProps<BaseComponentColorNameType>,
