...
import classNames from "./Delete.module.scss";
import type DeleteProps from "./DeleteProps";
import type BaseDeleteProps from "./BaseDeleteProps";

export default function Delete<
  BaseComponentColorNameType extends string = ColorName | "rainbow",
  PropsType extends BaseDeleteProps<BaseComponentColorNameType> =
    DeleteProps<BaseComponentColorNameType>,
