...
import type BaseDialogueMessageProps from "./BaseDialogueMessageProps";
...
export default function DialogueMessage<
  ...
  PropsType extends BaseDialogueMessageProps<BaseComponentColorNameType> =
    DialogueMessageProps<BaseComponentColorNameType>,
