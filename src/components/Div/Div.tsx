...
import type DivProps from "./DivProps";
import type BaseDivProps from "./DivProps";

export default function Div<
  BaseComponentColorNameType extends string = ColorName | "rainbow",
  PropsType extends BaseDivProps<BaseComponentColorNameType> =
    DivProps<BaseComponentColorNameType>,
